...
(function() {
    ...
    if (
        ...
        "https://nouveau-europresse-com.bsg-ezproxy.univ-paris3.fr/*".includes(hostname) ||
        "https://nouveau-europresse-com.eu1.proxy.openathens.net/*".includes(hostname) ||
        "https://nouveau.europresse.com/access/ip/default.aspx?un=U033137T_1".includes(hostname)) {
    ...
    if ("https://www.sciencesetavenir.fr/*".includes(hostname)) {
    ...
    if ("https://www.larecherche.fr/*".includes(hostname)) {
    ...
    if ("https://www.science-et-vie.com/*".includes(hostname)) {
    ...
    if ("https://investir.lesechos.fr/*".includes(hostname)) {
    ...
    if ("https://www.jeuneafrique.com/*".includes(hostname)) {
    ...
    if ("https://www.leberry.fr/*".includes(hostname)) {
